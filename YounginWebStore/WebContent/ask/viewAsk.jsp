...
<h1 align="center"><font face="¸¼Àº °íµñ" color="#1F497D">¹°Ç°½ÅÃ»Á¤º¸</font></h1>
<br/>
<table border=1 width="700" cellspacing=0 bgcolor="#F1F3F6" bordercolor="white" bordercolordark="white" bordercolorlight="silver" align="center">
	<tr>
        <td><font face="¸¼Àº °íµñ">½ÅÃ»ID</font></td>
        <td colspan=3>
        <input type="text" name="writer" readonly maxlength="12" size="12" value="${ASK.writer}">
        </td>
    </tr>
    <tr>
    ...
    <tr>
        <td width="150"><font face="¸¼Àº °íµñ">¼ö·®</font></td>
        <td colspan="3">
	        ${ASK.regNo}
        </td>
    </tr>
    ...
    <tr>
        <td><font face="¸¼Àº °íµñ">ÇÐ°ú¸í</font></td>
        <td  width="150">
	        ${ASK.name}
        </td>
    ...
    <tr>
        <td><font face="¸¼Àº °íµñ">Ã³¸®À¯¹«</font></td>
        <td colspan=3>
	        ${ASK.status.codeName}
        </td>
    </tr>
    <tr>
        <td><font face="¸¼Àº °íµñ">³²±â´Â¸»</font></td>
        <td colspan=3>
	        ${ASK.details}
        </td>
    </tr>
	...
	<br>
<font face="¸¼Àº °íµñ"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</font><font face="¸¼Àº °íµñ"><b><c:url var="askURL" value="/Ask" />
</b></font><a href='${askURL}?method=editAskForm&id=${ASK.id}'><font face="¸¼Àº °íµñ">¼öÁ¤ÇÏ±â</font></a><font face="¸¼Àº °íµñ">
</font><a href='${askURL}?method=removeAsk&id=${ASK.id}'><font face="¸¼Àº °íµñ">»èÁ¦ÇÏ±â</font></a><font face="¸¼Àº °íµñ">
</font><a href='${askURL}?method=viewAskList'><font face="¸¼Àº °íµñ">¸ñ·Ïº¸±â</font></a><font face="¸¼Àº °íµñ">
</font>
