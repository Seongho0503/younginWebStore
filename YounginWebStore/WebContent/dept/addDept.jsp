...
<form method="post" action="${deptURL}">
    <h1 align="center"><font face="¸¼Àº °íµñ" color="#1F497D">¹°Ç°µî·Ï</font></h1>
	<br/>
    <table border=1 width="700" cellspacing=0 bgcolor="#F1F3F6" bordercolor="white" bordercolordark="white" bordercolorlight="silver" align="center">
        <tr>
            ...
            <td colspan="3">
				<input type="text" name="name" size="10" maxlength="10"/ style="background-color:white; border-width:1; border-style:solid;">
            </td>
        </tr>
        <tr>
            <td><font face="¸¼Àº °íµñ">Ç°¸ñÄÚµå</font></td>
            <td colspan="3">
				<input type="text" name="code" size="10" maxlength="10"/ style="background-color:white; border-width:1; border-style:solid;">
            </td>
        </tr>
        ...
        <tr>
            ...
            <td>
				<font face="¸¼Àº °íµñ"><input type="text" name="price" maxlength="10" size="10"/ style="background-color:white; border-width:1; border-style:solid;">¿ø</font>
            </td>
            <td><font face="¸¼Àº °íµñ">Á¦°í¼ö·®</font></td>
            <td>
			<font face="¸¼Àº °íµñ"><select name="max_cnt"><!-- 0 ¿¡¼­ ºÎÅÍ 1000 °¡Áö 10¾¿ Áõ°¡ÇÏ¸é¼­ ¹Ýº¹ ¹®À» ½ÇÇà ÇÏ¸é¼­ i °ªÀ» Ãâ·Â -->
                    <c:forEach begin="0" end="1000" step="10" var="i">
...
<input type="reset" value="ÀçÀÔ·Â" / style="background-color:rgb(241,243,246); border-width:1; border-color:rgb(241,243,246); border-style:solid;">
<a href='${deptURL}?method=viewDeptList'><font face="¸¼Àº °íµñ">¸ñ·Ïº¸±â</font></a><font face="¸¼Àº °íµñ">
</font>
</form>
