                                ...
                                <td width="1004" height="579">
                                    ...
                                    <table cellpadding="0" cellspacing="0" width="1002">
                                        <tr valign="top">
											...
											<h1 align="center"><font face="¸¼Àº °íµñ" color="#1F497D">¹°Ç°»ó¼¼Á¤º¸</font></h1>
<br/>
<table border=1 width="700" cellspacing=0 bgcolor="#F1F3F6" bordercolor="white" bordercolordark="white" bordercolorlight="#CCCCCC" align="center">
    <tr>
        <td width="150"><font face="¸¼Àº °íµñ">Ç°¸ñÄÚµå</font></td>
        <td colspan="3">
<font face="¸¼Àº °íµñ">								<c:out value="${DEPT.code}"/>
</font>						</td>
    </tr>
    <tr>
        <td><font face="¸¼Àº °íµñ">Ç°¸ñ</font></td>
        <td colspan="3">
<font face="¸¼Àº °íµñ">	        		        	<c:out value="${DEPT.name}"/>
</font>						</td>
    </tr>
    <tr>
        <td><font face="¸¼Àº °íµñ">°¡°Ý</font></td>
        <td colspan="3">
<font face="¸¼Àº °íµñ">								<c:out value="${DEPT.price}"/>¿ø</font>
        </td>
    </tr>
    <tr>
        <td><font face="¸¼Àº °íµñ">¼ö·®</font></td>
        <td colspan=3>
<font face="¸¼Àº °íµñ">								<c:out value="${DEPT.maxAskCnt}"/>°³ ÀÌÇÏ</font>
        </td>
    </tr>
  	          
</table>
	<p align="left">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href='<%= request.getContextPath() %>/Dept?method=editDeptForm&code=<c:out value="${DEPT.code}"/>'><font face="¸¼Àº °íµñ">&nbsp;¼öÁ¤ÇÏ±â</font></a><font face="¸¼Àº °íµñ">
</font><a href='<%= request.getContextPath() %>/Dept?method=viewDeptList'><font face="¸¼Àº °íµñ">¸ñ·Ïº¸±â</font></a></p>
<font face="¸¼Àº °íµñ">
</font>
