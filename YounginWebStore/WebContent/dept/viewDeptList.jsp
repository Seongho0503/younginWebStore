                                ...
                                <td width="1004" height="579">
                                    ...
                                    <table cellpadding="0" cellspacing="0" width="1002">
                                        <tr valign="top">
											...
											<H1 align="center"><font face="¸¼Àº °íµñ" color="#1F497D">ÇÐ±³¹°Ç°°ü¸®</font></H1>
<table border=1 width="700" cellspacing=0 bgcolor="#F1F3F6" bordercolor="white" bordercolordark="white" bordercolorlight="#CCCCCC" align="center">
    <tr>
        <th width="10">
            <p align="center"><font face="¸¼Àº °íµñ">NO</font></p>
        </th>
        <th>
            <p align="center"><font face="¸¼Àº °íµñ">Ç°¸ñ</font></p>
        </th>
        <th>
            <p align="center"><font face="¸¼Àº °íµñ">CODE</font></p>
        </th>
    </tr>
    <c:forEach var="DEPT" items="${DEPT_LIST}" varStatus="i">
    <c:url var="viewURL" value="/Dept">
    <c:param name="method" value="viewDept" />
    <c:param name="code" value="${DEPT.code}" />
    </c:url>
    <tr>
        <td>
            <p align="center"><a href='${viewURL}'>${i.count}</a></p>
        </td>
        <td>
            <p align="center"><a href='${viewURL}'>${DEPT.name}</p>
        </td>
        <td>
            <p align="center"><a href='${viewURL}'>${DEPT.code}</a></p>
        </td>
    </tr>
    </c:forEach>
...
<p align="left"><c:url var="addURL" value="/servlet/ask">
<c:param name="method" value="addDept"/>
</c:url>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href='${addDept}'><font face="¸¼Àº °íµñ">µî·ÏÇÏ±â</font></a></p>
<font face="¸¼Àº °íµñ">
</font>
											</td>
                                        </tr>
