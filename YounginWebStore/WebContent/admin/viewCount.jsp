...
<table border="0" cellpadding="0" cellspacing="0" width="1240" height="630">
    ...
    <tr>
        ...
        <th>
            <p align="center"><font face="¸¼Àº °íµñ">³¯Â¥</font></p>
        </th>
        <th>
            <p align="center"><font face="¸¼Àº °íµñ">¾ÆÀÌµð</font></p>
        </th>
        <th>
            <p align="center"><font face="¸¼Àº °íµñ">·Î±×ÀÎÈ½¼ö</font></p>
        </th>
        <th>
            <p align="center"><font face="¸¼Àº °íµñ">ÀÌ¸§</font></p>
        </th>
        <th>
            <p align="center"><font face="¸¼Àº °íµñ">ÀÌ¸ÞÀÏ</font></p>
        </th>
        <th>
            <p align="center"><font face="¸¼Àº °íµñ">ÇÐ°ú</font></p>
        </th>
    </tr>
											<c:forEach var="COUNT" items="${COUNT_LIST}" varStatus="counter">
											<tr>
											<td width=100>
											${counter.count}
												<td>
												...
												<td>
													<p align="center">${COUNT.login_count}</p>
												</td>
												<td>
													${COUNT.member_name}
												</td>
