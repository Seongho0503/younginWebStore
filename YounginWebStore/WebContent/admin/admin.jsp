...
<title>Youngini Web Store</title>
    ...
    <tr>
        <td width="1240" valign="top">
            ...
            <table width="1258" height="497" cellpadding="0" cellspacing="0" background="images/bg.gif">
                <tr style="border-color:rgb(0,51,204); border-style:none; text-align: center;">
                    <td width="1000" height="497" style="font-size: 32px;">관리자 전용 페이지입니다.</td>
