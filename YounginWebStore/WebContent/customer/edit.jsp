...
<c:url value="/Customer" var="editEditURL"></c:url>
                                    ...
                                    <table cellpadding="0" cellspacing="0">
                                        <tr>
                                            <td width="663" height="55" valign="top">
                                                ...
                                                <table border="0" cellpadding="0" cellspacing="0" width="621" bgcolor="white">
                                                    <tr>
                                                        <td width="129" height="55"><img src="images/img_edit/edit_notice.gif" width="129" height="55" border="0"></td>
                                                        <td width="492"></td>
                                                    </tr>
                                                </table>
</td>
                                        ...
                                        <tr>
                                            <td width="803" height="242" valign="top">
												<form  name="form1" action="${editEditURL}" method="post">
                                                <table cellpadding="0" cellspacing="0">
                                                    <tr>
                                                ...
                                                <table cellpadding="0" cellspacing="0" width="621">
                                                    <tr>
                                                        ...
                                                        <td width="438" bgcolor="white" height="25"><input type="text" name="customerName" readonly maxlength="12" size="12" value="${sessionScope.CUSTOMER.m_name}"></td>
                                                    </tr>
                                                    <tr>
                                                        <td width="140" bgcolor="#F7FDFD" style="margin-left:0;" height="25"><font face="굴림체"><span style="font-size:9pt;">&nbsp;&nbsp;아이디</span></font></td>
                                                        <td width="438" bgcolor="white" height="25"><input type="text" name="customerId" readonly maxlength="12" size="12" value="${sessionScope.CUSTOMER.m_id}"></td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td width="438" bgcolor="white" height="25"><input type="text" name="customerEmail" maxlength="20" size="20" value="${sessionScope.CUSTOMER.email}"></td>
                                                    </tr>
                                                    <tr>
                                                        <td width="140" bgcolor="#F7FDFD" style="margin-left:0;" height="25"><font face="굴림체"><span style="font-size:9pt;">&nbsp;&nbsp;주소</span></font></td>
                                                        <td width="438" bgcolor="white" height="25"><input type="text" name="customerAddress" maxlength="40" size="40" value="${sessionScope.CUSTOMER.address}"></td>
                                                    </tr>
                                                    <tr>
                                                        <td width="140" bgcolor="#F7FDFD" style="margin-left:0;" height="25"><font face="굴림체"><span style="font-size:9pt;">&nbsp;&nbsp;학 과</span></font></td>
                                                        <td width="438" bgcolor="white" height="25"><input type="text" name="customerDept" readonly maxlength="15" size="15" value="${sessionScope.CUSTOMER.dept}"></td>
                                                    </tr>
                                                    <tr>
                                                        <td width="140" bgcolor="#F7FDFD" style="margin-left:0;" height="25"><font face="굴림체"><span style="font-size:9pt;">&nbsp;&nbsp;학 번</span></font></td>
                                                        <td width="438" bgcolor="white" height="25"><input type="text" name="customerSno" readonly maxlength="15" size="15" value="${sessionScope.CUSTOMER.s_no}"></td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <input type="image" src="images/img_edit/edit_ok.gif" width="67" height="26" border="0" onClick="validate()"><span style="font-size:1pt;"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><a href="${editURL}"><img src="images/img_apply/apply_cancel.gif" width="66" height="26" border="0"></a></td>
                                                    </tr>
                                                    <tr>
