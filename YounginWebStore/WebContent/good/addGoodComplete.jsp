...
<c:url value="/Good" var="addAgain">
	<c:param name="method" value="addGoodForm"/>
</c:url>
...
&nbsp;
                                ...
                                <td width="868" height="451">
                                    <table cellpadding="0" cellspacing="0">
                                        <tr>
                                            <td width="663" height="45" valign="top">
<b><font size="6">물품 등록을 완료했습니다.</font></b>
</td>
                                        </tr>
                                        <tr>
                                            <td width="803" height="281" valign="top">

								<a href="${addAgain}"><img src="images/img_admin/keepgoon.gif" width="69" height="31" border="0"></a>
						 &nbsp;<a href="${home}"><img src="images/img_admin/stop.gif" width="69" height="31" border="0"></a><br>
</td>
                                        </tr>
                                    </table></td>
