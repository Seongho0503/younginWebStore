...
<center>
  ...
  <table border=1>
    ...
    <tr>
     <td>합계</td><td colspan=2>${total}</td>
    </tr>
  </table>
 </center>
<%--세션 객체에 장바구니에( cart) 저장된 
물건의 목록을 반복문을 이용해서 출력하고
request 의 total속성 을 출력한다
JSTL 로 구현
--%>
<%--세션에 저장된 cart 속성 삭제 --%>
<c:remove var="cart" scope="session"/></td>
                                        </tr>
                                    </table>
								</td>
                            </tr>
