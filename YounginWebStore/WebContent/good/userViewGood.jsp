        ...
        <td width="1240" valign="top">
            ...
            <table cellpadding="0" cellspacing="0" width="1258">
                <tr>
                    ...
                    <td width="107" height="31"><a href="${purchase}"><img src="images/img_user/user_purchase.gif" width="107" height="31" border="0"></td>
                    ...
                    <td width="73" height="31"><a href="${buyURL}"><img src="images/img_main/details.gif" width="73" height="31" border="0"></td>
...
<input type=hidden name=gname value="${GOOD.gname}"> 
